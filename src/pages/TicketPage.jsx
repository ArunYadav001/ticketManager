            ...
            <div className="ticket-container">
                <form onSubmit={handleSubmit}>
                    <section>
                        ...
                        <input id="new-category" type="text" name="category" onChange={handleChange}
                            value={formData.category}
                        />
                        ...
                        <div className="multiple-input-container">
                            ...
                            />
                            <label htmlFor="priority-4">5</label>
                            <input
                                id="priority-5"
                                name="priority"
                                type="radio"
                    ...
                    <section>
                        ...
                        <input id="owner" type="text" name="owner" onChange={handleChange}
                            required={true}
                            value={formData.owner}
                        />
                        <label htmlFor="avater">Avatar</label>
                        <input id="avatar" type="url" name="avatar" onChange={handleChange}
